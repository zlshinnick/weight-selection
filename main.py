...
def get_args_parser():
    ...
    # Mimetic initialization parameters
    parser.add_argument(
        "--mimetic_init",
        type=str2bool,
        default=False,
        help="Enable mimetic initialization for attention weights",
    )
    parser.add_argument(
        "--mimetic_alpha",
        type=float,
        default=0.4,
        help="Mimetic init: scaling factor for random component (default: 0.4)",
    )
    parser.add_argument(
        "--mimetic_beta",
        type=float,
        default=0.4,
        help="Mimetic init: scaling factor for identity component (default: 0.4)",
    )
    parser.add_argument(
        "--mimetic_dist",
        type=str,
        default="uniform",
        help='Mimetic init: distribution type - "uniform" or "normal" (default: uniform)',
    )
    ...
    # * Finetuning params
    parser.add_argument("--initialize", default="", help="initialize from a model file")
    parser.add_argument(
        "--head_init_scale",
        default=1.0,
        type=float,
    ...
    parser.add_argument("--data_set", default="IMNET", type=str, help="dataset path")
    parser.add_argument(
